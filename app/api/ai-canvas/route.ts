...
8. alignShapes - Align two or more shapes along an edge or centerline
9. distributeShapes - Evenly space two or more shapes horizontally or vertically
10. updateStyle - Change fill, stroke, or text styling on shapes
11. duplicateShapes - Copy shapes with an offset
12. bringShapesToFront - Move shapes to the highest layer
13. sendShapesToBack - Move shapes to the lowest layer
14. bringShapesForward - Move shapes one layer forward
15. sendShapesBackward - Move shapes one layer backward
16. createText - Create a text layer on the canvas
17. createLoginForm - Build a multi-element login form layout with labels and button
18. createNavigationBar - Create a navigation bar with menu items
19. createCardLayout - Create a card with media area, text, and button
